 ...
 */
enum ZclStatusCodeT ZbZclIasWdClientStartWarningReq(struct ZbZclClusterT *cluster,
 ...
 * @return ZCL_STATUS_SUCCESS if successful, or other ZclStatusCodeT value on error
 */
enum ZclStatusCodeT ZbZclIasWdClientSquawkReq(struct ZbZclClusterT *cluster,
    const struct ZbApsAddrT *dst,
    struct ZbZclIasWdClientSquawkReqT *squawk_req,
    void (*callback)(struct ZbZclCommandRspT *zcl_rsp, void *arg), void *arg);
