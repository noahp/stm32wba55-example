...
/* e.g. LINK_LIST_INSERT_BEFORE */
/*lint -e661 "Possible access of out-of-bounds pointer [MISRA 2012 Rule 18.1, REQUIRED]" */
...
/*lint --emacro((413),LINK_LIST_ITEM) "Likely use of null pointer in left argument to operator '->' [MISRA Rule 1.3 (REQUIRED)]" */
/*lint --emacro((511),LINK_LIST_ITEM) "Size incompatibility in cast from 'unsigned long' (8 bytes) to 'struct ZbMsgT *' (4 bytes) [LINT]" */
/*lint --emacro((613),LINK_LIST_ITEM) "Possible use of null pointer 'zb' in left argument to operator '->' [LINT]" */
/*lint --emacro((923),LINK_LIST_ITEM) "Cast from pointer to unsigned long [MISRA Rule 11.6 (REQUIRED)]" */
/*lint --emacro((9033),LINK_LIST_ITEM) "Impermissible cast of composite expression (different essential type categories) [MISRA Rule 10.8 (REQUIRED)]" */
