...
#define IEEE802154_TYPE_RESERVED                    0x4U
#define IEEE802154_TYPE_MULTI                       0x5U
#define IEEE802154_TYPE_FRAG_FRAK                   0x6U
#define IEEE802154_TYPE_EXTENDED                    0x7U
...
#define IEEE802154_FCTRL_DST_POS                    10U
...
#define IEEE802154_FCTRL_SRC_POS                    14U
...
#define IEEE802154_SCTRL_FC_SIZE                    0x40U /* Note, in 2015 spec, this is now IEEE802154_SCTRL_ASN_IN_NONCE */
...
struct ieee802154_hdr * ieee802154_parse_header(struct ieee802154_hdr *hdr, const uint8_t *p,
    uint16_t len, const uint8_t **end);

uint16_t ieee802154_write_header(const struct ieee802154_hdr *hdr, uint8_t *q, uint16_t maxlen);

int ieee802154_addr_match(const struct ieee802154_hdr *hdr, uint16_t panid, uint64_t ext_addr,
    uint16_t short_addr, uint8_t simple_addr, uint8_t coordinator);
...
const void * ieee802154_ie_start(const void *ie, unsigned int len);
const void * ieee802154_ie_next(const void *ie, unsigned int len);
unsigned int ieee802154_ie_list_length(const void *ie, unsigned int len);
...
const void * ieee802154_mie_start(const void *ie, unsigned int len);
const void * ieee802154_mie_next(const void *ie, unsigned int len);
...
const void * ieee802154_zie_start(const void *ie, unsigned int len);
const void * ieee802154_zie_next(const void *ie, unsigned int len);
...
int ieee802154_decrypt(const struct ieee802154_hdr *hdr, uint8_t *p, unsigned int len,
