...
#define WS_FAN11_SHIFT          8U /* FAN 1.1 values are shifted up from FAN 1.0 values */
#define WS_PHYTYPE_SHIFT        4U /* PHY Type is in upper 4 bits of FAN 1.1 PhyModeID. */
enum {
    mcp_WS_MOD_FSK = (0x00UL << (WS_FAN11_SHIFT + WS_PHYTYPE_SHIFT)),
    mcp_WS_MOD_FSK_FEC = (0x01UL << (WS_FAN11_SHIFT + WS_PHYTYPE_SHIFT)),
    mcp_WS_MOD_OFDM_OPT1 = (0x02UL << (WS_FAN11_SHIFT + WS_PHYTYPE_SHIFT)),
    mcp_WS_MOD_OFDM_OPT2 = (0x03UL << (WS_FAN11_SHIFT + WS_PHYTYPE_SHIFT)),
    mcp_WS_MOD_OFDM_OPT3 = (0x04UL << (WS_FAN11_SHIFT + WS_PHYTYPE_SHIFT)),
    mcp_WS_MOD_OFDM_OPT4 = (0x05UL << (WS_FAN11_SHIFT + WS_PHYTYPE_SHIFT)),
};

/* Wi-SUN FAN 1.1 FSK PHY Operating Modes */
enum {
    mcp_WS_FSK_OPMODE_1A = (0x01UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_1B = (0x02UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_2A = (0x03UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_2B = (0x04UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_3 = (0x05UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_4A = (0x06UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_4B = (0x07UL << WS_FAN11_SHIFT),
    mcp_WS_FSK_OPMODE_5 = (0x08UL << WS_FAN11_SHIFT),
};

/* Wi-SUN FAN 1.1 OFDM MCS levels */
enum {
    mcp_WS_OFDM_MCS_0 = (0x00UL << WS_FAN11_SHIFT),
    mcp_WS_OFDM_MCS_1 = (0x01UL << WS_FAN11_SHIFT),
    mcp_WS_OFDM_MCS_2 = (0x02UL << WS_FAN11_SHIFT),
    mcp_WS_OFDM_MCS_3 = (0x03UL << WS_FAN11_SHIFT),
    mcp_WS_OFDM_MCS_4 = (0x04UL << WS_FAN11_SHIFT),
    mcp_WS_OFDM_MCS_5 = (0x05UL << WS_FAN11_SHIFT),
    mcp_WS_OFDM_MCS_6 = (0x06UL << WS_FAN11_SHIFT),
};
